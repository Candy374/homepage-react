...
const Block_img_up = (props) => {
    ...
    const img = icon ? <i className={'cl-icons icon-' + icon}></i> : <img className="avatar" src={"/assets/" + image}/>
    return (
                ...
                <content>
                    ...
                    <section className="category justify-between direction-row">
                        <Block_img_up
                            icon="chanpin"
                            title="产品支持"
                            desc="战略目标制定，阶段目标协助执行，定 期优秀运营案例分享。"
                        />

                        <Block_img_up
                            icon="yunyingshuju"
                            title="运营支持"
                            desc="专项市场费用、共享品牌投放效益、宣 传物料支持，展会活动支持，行业合作 撮合。"
                        />

                        <Block_img_up
                            icon="jiaoyishichang"
                            title="市场支持"
                            desc="灵活的销售策略、客户特惠福利，销售 返点、促销支持，售前指导、协助公关。"
                        />

                        <Block_img_up
                            icon="zhenduishichang"
                            title="销售支持"
                            desc="全方位产品功能详解、产品应用场景解 析，销售经验分享、销售话术、市场建 议。"
                        />

                        <Block_img_up
                            icon="peixun"
                            title="培训支持"
                            desc="强大的售后团队、高效反馈机制、技术 响应。"
                        />
                    ...
                    <section className="how-to-join">
                        <Block icon="number" num="1" title="产品"
                               desc="是国内第一个一站式营销云解决方案，覆盖企业营销所需的各个环节。" />

                        <Block icon="number" num="2" title="产品"
                               desc="是国内第一个一站式营销云解决方案，覆盖企业营销所需的各个环节。" />

                        <Block icon="number" num="3" title="产品"
                               desc="是国内第一个一站式营销云解决方案，覆盖企业营销所需的各个环节。" />

                        <Block icon="number" num="4" title="产品"
                               desc="是国内第一个一站式营销云解决方案，覆盖企业营销所需的各个环节。" />
                    </section>
